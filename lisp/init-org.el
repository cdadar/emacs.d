...
(use-package org-pomodoro
  ...
  :hook
  ((org-pomodoro-finished . (lambda () (notify-send "Pomodoro completed!" "Time for a break.")))
   (org-pomodoro-break-finished . (lambda () (notify-send "Pomodoro Short Break Finished" "Ready for Another?")))
   (org-pomodoro-long-break-finished . (lambda () (notify-send "Pomodoro Long Break Finished" "Ready for Another?")))
   (org-pomodoro-killed . (lambda () (notify-send "Pomodoro Killed" "One does not simply kill a pomodoro!")))))
